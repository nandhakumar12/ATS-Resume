...
This directory contains the Infrastructure as Code (IaC) definitions for the AI ATS Resume platform. The architecture is designed to satisfy the core Learning Outcomes (LO) of the MSc Cloud Platform Programming (CPP) module.
...
- **CPP Goal:** Demonstrates global content delivery (LO4).
...
- **CPP Goal:** Demonstrates managed compute and secure identity management (LO1, LO3).

### 3. Data Tier (Persistence)
- **Service:** Amazon DynamoDB (NoSQL).
- **Design:** Partitioned schemas for Resumes, Jobs, and Users.
- **CPP Goal:** Demonstrates high-performance managed database services (LO1).
...
- **CPP Goal:** Demonstrates advanced cloud security patterns (LO3).
...
- **CPP Goal:** Demonstrates cloud system monitoring and metrics (LO5).
